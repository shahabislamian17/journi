...
export const experiencesAPI = {
  ...
  getBySlug: (slug) => apiRequest(`/api/experiences/${slug}`),
  create: (data) => apiRequest('/api/experiences', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id, data) => apiRequest(`/api/experiences/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
};
...
export const wishlistAPI = {
  ...
  add: (experienceId, options = {}) => {
    ...
    console.log('wishlistAPI.add called with:', { experienceId, validExpId, isNumeric, isUUID });
